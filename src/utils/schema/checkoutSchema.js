...
export const schema = yup.object().shape({
  ...
  cpf: yup.string().validateCPF("Insira um CPF válido").required("O campo CPF obrigatório"),
  email: yup.string().email("O campo e-mail deve ser um email válido").required("O campo e-mail obrigatório"),
  cep: yup.string().validateCEP("Insira um CEP válido").required("O campo CEP obrigatório"),
  cel: yup.string().validateCEL("Insira um celular válido").required("O campo celular obrigatório"),
